...
export function SidebarDrawer({ activeTab, onNavigate }: SidebarDrawerProps) {
  return <aside className="hidden w-64 shrink-0 border-r border-white/10 bg-[#0d121c] lg:flex lg:flex-col">
    <div className="flex h-16 items-center gap-3 border-b border-white/10 px-5"><img src="/1logo.png.jpeg" alt="Academia.ai Logo" className="h-10 w-10 shrink-0 object-contain drop-shadow-[0_0_15px_rgba(168,85,247,0.7)]" /><div className="flex flex-col"><h1 className="text-lg font-bold leading-none tracking-wide text-white">Academia.ai</h1><span className="mt-1 text-[10px] font-semibold uppercase tracking-widest text-purple-400">LEARNING OS</span></div></div>
